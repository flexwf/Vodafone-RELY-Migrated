...
{
    public class LFSSectionViewModel
    {
        [Display(Name = "Id")]
        ...
        [MaxLength(255, ErrorMessage = " Section Name can be maximum 255 characters")]
        public string SectionName { get; set; }

        [RestrictSpecialChar]
        [Display(Name = "Section Code")]
        [Required(ErrorMessage = "Section Code  is required")]
        [MaxLength(20, ErrorMessage = " Section Code can be maximum 20 characters")]
